...
//importar funcion para dias transcurridos
...
<table id="example<?php echo $varGral;?>" class="table table-striped table-bordered" style="width:100%">
        ...
        <thead>
            <tr class='hTabla'>
                ...
                <th scope="col">Días transcurridos en su creación</th>
        ...
        while( $row = mysqli_fetch_array($consultar) ) {
            ...
            //Dias trascurridos
            $dias = dias_transcurridos($fecha,$fecha_create);
            $diasTranscurridos = substr($dias, 1);
            ...
            <tr class="centrar">
                ...
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="editar btn btn-outline-success btn-sm activo" id="btnEditar<?php echo $varGral?><?php echo $n?>" onclick="llenar_temas_editar('<?php echo $id?>','<?php echo $nombre?>','<?php echo $color_letra?>','<?php echo $color_base?>','<?php echo $color_base_fuerte?>','<?php echo $color_borde?>')">
                                <i class="far fa-edit fa-lg"></i>
                    </button>
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="imprimir btn btn-outline-primary btn-sm activo">
                                <i class="fas fa-file-export fa-lg"></i>
                    </button>
                </td>
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="ventana btn btn-outline-primary btn-sm activo"  id="">
                ...
                <td>
                    <label class="textoBase">
                        <?php echo $diasTranscurridos.' dias desde su creacion'?>
                    </label>
                </td>
                <td>
                    <label class="textoBase">
